...
public class RestError {
  ...
  public enum ErrorReasonEnum {
    ...
    TELLER_CANNOT_POST_TRANSACTION_WITHOUT_OPENED_TILL("TELLER_CANNOT_POST_TRANSACTION_WITHOUT_OPENED_TILL"),
    ...
    ACCOUNT_HAS_LESS_PAYMENT_HOLIDAY_ACCRUED_INTEREST_THAN_THE_PROVIDED_AMOUNT_TO_APPLY("ACCOUNT_HAS_LESS_PAYMENT_HOLIDAY_ACCRUED_INTEREST_THAN_THE_PROVIDED_AMOUNT_TO_APPLY"),
    ...
    INVALID_CHARACTERS_IN_ROLE_ID("INVALID_CHARACTERS_IN_ROLE_ID"),
    
    ROLE_NAME_ALREADY_IN_USE("ROLE_NAME_ALREADY_IN_USE"),
    
    REMOVED_ADMIN_FOR_CURRENT_USER("REMOVED_ADMIN_FOR_CURRENT_USER"),
    
    ADDED_ADMIN_FOR_CURRENT_USER("ADDED_ADMIN_FOR_CURRENT_USER"),
    
    REMOVED_MAMBU_ACCESS_RIGHT_FOR_CURRENT_USER("REMOVED_MAMBU_ACCESS_RIGHT_FOR_CURRENT_USER"),
    
    MISSING_REQUIRED_BRANCH("MISSING_REQUIRED_BRANCH"),
    
    A_TELLER_CAN_SEE_ONLY_ONE_BRANCH("A_TELLER_CAN_SEE_ONLY_ONE_BRANCH"),
    
    CANNOT_REMOVE_TELLER_PROPERTY("CANNOT_REMOVE_TELLER_PROPERTY"),
    
    CANNOT_CHANGE_BRANCH_ASSIGNMENT("CANNOT_CHANGE_BRANCH_ASSIGNMENT"),
    
    CANNOT_DELETE_TELLER("CANNOT_DELETE_TELLER"),
    
    A_TELLER_CANNOT_BE_ADMINISTRATOR("A_TELLER_CANNOT_BE_ADMINISTRATOR"),
    
    CREDIT_OFFICER_PROPERTY_REMOVED("CREDIT_OFFICER_PROPERTY_REMOVED"),
    
    CREDIT_OFFICER_PROPERTY_REMOVED_FROM_ROLE("CREDIT_OFFICER_PROPERTY_REMOVED_FROM_ROLE"),
    
    USER_BRANCH_CHANGE("USER_BRANCH_CHANGE"),
    
    USER_DEACTIVATED("USER_DEACTIVATED"),
    
    USER_DELETED("USER_DELETED"),
    
    SUPPORT_ROLE_CANNOT_BE_ASSIGNED_TO_AN_ADMINISTRATOR("SUPPORT_ROLE_CANNOT_BE_ASSIGNED_TO_AN_ADMINISTRATOR"),
    
    SUPPORT_ROLE_CANNOT_BE_ASSIGNED_TO_A_TELLER("SUPPORT_ROLE_CANNOT_BE_ASSIGNED_TO_A_TELLER"),
    
    SUPPORT_ROLE_CANNOT_BE_ASSIGNED_TO_A_REGULAR_USER("SUPPORT_ROLE_CANNOT_BE_ASSIGNED_TO_A_REGULAR_USER"),
    
    SUPPORT_ROLE_NAME_CANNOT_BE_CHANGED("SUPPORT_ROLE_NAME_CANNOT_BE_CHANGED"),
    
    SUPPORT_ROLE_USER_RIGHTS_CANNOT_BE_CHANGED("SUPPORT_ROLE_USER_RIGHTS_CANNOT_BE_CHANGED"),
    
    SUPPORT_ROLE_PERMISSIONS_MUST_BE_VIEW_ONLY("SUPPORT_ROLE_PERMISSIONS_MUST_BE_VIEW_ONLY"),
    
    INVALID_ROLE_NAME("INVALID_ROLE_NAME"),
    
    ROLES_CONFIGURATION_EMPTY("ROLES_CONFIGURATION_EMPTY"),
    ...
    INVALID_NOTES_LENGTH("INVALID_NOTES_LENGTH"),
    
    FEE_AMORTIZATION_PROFILE_CANNOT_BE_CHANGED("FEE_AMORTIZATION_PROFILE_CANNOT_BE_CHANGED"),
    
    FEE_AMORTIZATION_FREQUENCY_CANNOT_BE_CHANGED("FEE_AMORTIZATION_FREQUENCY_CANNOT_BE_CHANGED"),
    
    FEE_AMORTIZATION_PROFILE_IS_NOT_PROVIDED("FEE_AMORTIZATION_PROFILE_IS_NOT_PROVIDED"),
    
    WITHDRAWAL_AMOUNT_GREATER_THAN_DUE_AMOUNT("WITHDRAWAL_AMOUNT_GREATER_THAN_DUE_AMOUNT"),
    
    WITHDRAWAL_COVERING_LATE_REPAYMENTS_NOT_ALLOWED_WITHOUT_REDRAW_REPAYMENT("WITHDRAWAL_COVERING_LATE_REPAYMENTS_NOT_ALLOWED_WITHOUT_REDRAW_REPAYMENT"),
    
    INTEREST_RATE_CHANGED_TRANSACTION_NOT_ALLOWED_FOR_DEPOSIT_PRODUCT_SETTINGS("INTEREST_RATE_CHANGED_TRANSACTION_NOT_ALLOWED_FOR_DEPOSIT_PRODUCT_SETTINGS"),
    
    INTEREST_RATE_CHANGED_NOT_ALLOWED_INTEREST_APPLIANCE_TRANSACTIONS_AFTER_VALUE_DATE("INTEREST_RATE_CHANGED_NOT_ALLOWED_INTEREST_APPLIANCE_TRANSACTIONS_AFTER_VALUE_DATE"),
    
    BLOCKED_BALANCE_SHOULD_BE_ZERO_OR_NULL("BLOCKED_BALANCE_SHOULD_BE_ZERO_OR_NULL"),
    
    FORWARD_AVAILABLE_BALANCE_SHOULD_BE_ZERO_OR_NULL("FORWARD_AVAILABLE_BALANCE_SHOULD_BE_ZERO_OR_NULL"),
    
    CUSTOM_FIELD_DEFAULT_SET_CANNOT_BE_MORE_THAN_ONE("CUSTOM_FIELD_DEFAULT_SET_CANNOT_BE_MORE_THAN_ONE"),
    
    CUSTOM_FIELD_DEFAULT_SET_ID_CANNOT_BE_CHANGED("CUSTOM_FIELD_DEFAULT_SET_ID_CANNOT_BE_CHANGED"),
    
    CUSTOM_FIELD_DEFAULT_SET_NAME_CANNOT_BE_CHANGED("CUSTOM_FIELD_DEFAULT_SET_NAME_CANNOT_BE_CHANGED"),
    
    CUSTOM_FIELD_DEFAULT_DESCRIPTION_CANNOT_BE_CHANGED("CUSTOM_FIELD_DEFAULT_DESCRIPTION_CANNOT_BE_CHANGED"),
    
    CUSTOM_FIELD_DEFAULT_SET_TYPE_CANNOT_BE_CHANGED("CUSTOM_FIELD_DEFAULT_SET_TYPE_CANNOT_BE_CHANGED"),
    
    CUSTOM_FIELD_SET_BLANK_ID("CUSTOM_FIELD_SET_BLANK_ID"),
    
    CUSTOM_FIELD_SET_INVALID_ID_LENGTH("CUSTOM_FIELD_SET_INVALID_ID_LENGTH"),
    
    CUSTOM_FIELD_SET_INVALID_ID_FORMAT("CUSTOM_FIELD_SET_INVALID_ID_FORMAT"),
    
    CUSTOM_FIELD_SET_MISSING_ID_PREFIX("CUSTOM_FIELD_SET_MISSING_ID_PREFIX"),
    
    CUSTOM_FIELD_SET_DUPLICATE_ID("CUSTOM_FIELD_SET_DUPLICATE_ID"),
    
    CUSTOM_FIELD_SET_ID_RESERVED_KEYWORD("CUSTOM_FIELD_SET_ID_RESERVED_KEYWORD"),
    
    CUSTOM_FIELD_SET_BLANK_NAME("CUSTOM_FIELD_SET_BLANK_NAME"),
    
    CUSTOM_FIELD_SET_NAME_LENGTH("CUSTOM_FIELD_SET_NAME_LENGTH"),
    
    CUSTOM_FIELD_SET_DUPLICATE_NAME("CUSTOM_FIELD_SET_DUPLICATE_NAME"),
    
    CUSTOM_FIELD_SET_TYPE_REQUIRED("CUSTOM_FIELD_SET_TYPE_REQUIRED"),
    
    CUSTOM_FIELD_SET_TYPE_CANNOT_BE_CHANGED("CUSTOM_FIELD_SET_TYPE_CANNOT_BE_CHANGED"),
    
    CUSTOM_FIELD_SET_AVAILABLE_FOR_REQUIRED("CUSTOM_FIELD_SET_AVAILABLE_FOR_REQUIRED"),
    
    CUSTOM_FIELD_SET_AVAILABLE_FOR_CANNOT_BE_CHANGED("CUSTOM_FIELD_SET_AVAILABLE_FOR_CANNOT_BE_CHANGED"),
    
    CUSTOM_FIELD_BLANK_ID("CUSTOM_FIELD_BLANK_ID"),
    
    CUSTOM_FIELD_INVALID_ID_LENGTH("CUSTOM_FIELD_INVALID_ID_LENGTH"),
    
    CUSTOM_FIELD_INVALID_ID_FORMAT("CUSTOM_FIELD_INVALID_ID_FORMAT"),
    
    CUSTOM_FIELD_DUPLICATE_ID("CUSTOM_FIELD_DUPLICATE_ID"),
    
    CUSTOM_FIELD_RESERVED_ID("CUSTOM_FIELD_RESERVED_ID"),
    
    CUSTOM_FIELD_BLANK_NAME("CUSTOM_FIELD_BLANK_NAME"),
    
    CUSTOM_FIELD_NAME_LENGTH("CUSTOM_FIELD_NAME_LENGTH"),
    
    CUSTOM_FIELD_DUPLICATE_NAME("CUSTOM_FIELD_DUPLICATE_NAME"),
    
    CUSTOM_FIELD_DEPENDENT_INVALID_TYPE_FOR_FIELD_WITH_DEPENDENT_FIELD("CUSTOM_FIELD_DEPENDENT_INVALID_TYPE_FOR_FIELD_WITH_DEPENDENT_FIELD"),
    
    CUSTOM_FIELD_DEPENDENT_FIELD_DOES_NOT_EXIST_IN_SET("CUSTOM_FIELD_DEPENDENT_FIELD_DOES_NOT_EXIST_IN_SET"),
    
    CUSTOM_FIELD_DEPENDENT_INVALID_TYPE_FOR_THE_DEPENDENT_FIELD("CUSTOM_FIELD_DEPENDENT_INVALID_TYPE_FOR_THE_DEPENDENT_FIELD"),
    
    CUSTOM_FIELD_SELECTIONS_OPTION_CANNOT_BE_DELETED("CUSTOM_FIELD_SELECTIONS_OPTION_CANNOT_BE_DELETED"),
    
    CUSTOM_FIELD_SELECTIONS_FOR_SELECTION_ID_PRESENT_BUT_NO_DEPENDENT_FIELD("CUSTOM_FIELD_SELECTIONS_FOR_SELECTION_ID_PRESENT_BUT_NO_DEPENDENT_FIELD"),
    
    CUSTOM_FIELD_SELECTIONS_DEPENDENT_FIELD_PRESENT_BUT_FOR_SELECTION_IS_MISSING("CUSTOM_FIELD_SELECTIONS_DEPENDENT_FIELD_PRESENT_BUT_FOR_SELECTION_IS_MISSING"),
    
    CUSTOM_FIELD_SELECTIONS_FOR_SELECTION_ID_COULD_NOT_BE_FOUND_IN_THE_DEPENDENT_FIELD("CUSTOM_FIELD_SELECTIONS_FOR_SELECTION_ID_COULD_NOT_BE_FOUND_IN_THE_DEPENDENT_FIELD"),
    
    CUSTOM_FIELD_SELECTIONS_DUPLICATED_SELECTION_IDS("CUSTOM_FIELD_SELECTIONS_DUPLICATED_SELECTION_IDS"),
    
    CUSTOM_FIELD_SELECTIONS_SELECTION_ID_SHOULD_NOT_BE_EMPTY("CUSTOM_FIELD_SELECTIONS_SELECTION_ID_SHOULD_NOT_BE_EMPTY"),
    
    CUSTOM_FIELD_SELECTIONS_SELECTION_ID_CONTAINS_INVALID_CHARACTERS("CUSTOM_FIELD_SELECTIONS_SELECTION_ID_CONTAINS_INVALID_CHARACTERS"),
    
    CUSTOM_FIELD_SELECTIONS_INVALID_SCORE_NUMBER("CUSTOM_FIELD_SELECTIONS_INVALID_SCORE_NUMBER"),
    
    CUSTOM_FIELD_SELECTIONS_DEPENDENT_FIELD_OPTIONS_NOT_COVERED("CUSTOM_FIELD_SELECTIONS_DEPENDENT_FIELD_OPTIONS_NOT_COVERED"),
    
    CUSTOM_FIELD_SELECTIONS_DUPLICATE_OPTION_VALUES("CUSTOM_FIELD_SELECTIONS_DUPLICATE_OPTION_VALUES"),
    
    CUSTOM_FIELD_SELECTIONS_VALUE_CANNOT_BE_EMPTY("CUSTOM_FIELD_SELECTIONS_VALUE_CANNOT_BE_EMPTY"),
    
    CUSTOM_FIELD_SELECTIONS_CIRCULAR_DEPENDENCY("CUSTOM_FIELD_SELECTIONS_CIRCULAR_DEPENDENCY"),
    
    CUSTOM_FIELD_SELECTION_OPTIONS_ARE_REQUIRED("CUSTOM_FIELD_SELECTION_OPTIONS_ARE_REQUIRED"),
    
    CUSTOM_FIELD_ACCESS_RIGHTS_INVALID_ROLE_ID("CUSTOM_FIELD_ACCESS_RIGHTS_INVALID_ROLE_ID"),
    
    CUSTOM_FIELD_SUPPORT_ROLE_INVALID_RIGHTS("CUSTOM_FIELD_SUPPORT_ROLE_INVALID_RIGHTS"),
    
    CUSTOM_FIELD_BLANK_ROLE_ID("CUSTOM_FIELD_BLANK_ROLE_ID"),
    
    CUSTOM_FIELD_USAGE_BLANK_ID("CUSTOM_FIELD_USAGE_BLANK_ID"),
    
    CUSTOM_FIELD_USAGE_ID_NOT_FOUND("CUSTOM_FIELD_USAGE_ID_NOT_FOUND"),
    
    CUSTOM_FIELD_INVALID_USAGE_FOR_RECORD_TYPE("CUSTOM_FIELD_INVALID_USAGE_FOR_RECORD_TYPE"),
    
    CUSTOM_FIELD_INVALID_USAGE_FOR_FIELD("CUSTOM_FIELD_INVALID_USAGE_FOR_FIELD"),
    
    CUSTOM_FIELD_USAGE_FOR_RECORD_TYPE_NOT_ALLOWED("CUSTOM_FIELD_USAGE_FOR_RECORD_TYPE_NOT_ALLOWED"),
    
    CUSTOM_FIELD_USAGE_FOR_RECORD_TYPE_REQUIRED("CUSTOM_FIELD_USAGE_FOR_RECORD_TYPE_REQUIRED"),
    
    CUSTOM_FIELD_SELECTION_USAGE_NOT_ALLOWED("CUSTOM_FIELD_SELECTION_USAGE_NOT_ALLOWED"),
    
    CUSTOM_FIELD_SELECTION_REQUIRED_NOT_ALLOWED("CUSTOM_FIELD_SELECTION_REQUIRED_NOT_ALLOWED"),
    
    CUSTOM_FIELD_SELECTION_DEFAULT_NOT_ALLOWED("CUSTOM_FIELD_SELECTION_DEFAULT_NOT_ALLOWED"),
    
    CUSTOM_FIELD_BLANK_TYPE("CUSTOM_FIELD_BLANK_TYPE"),
    
    CUSTOM_FIELD_TYPE_CHANGED("CUSTOM_FIELD_TYPE_CHANGED"),
    
    CUSTOM_FIELD_VALIDATION_RULES_NOT_ALLOWED("CUSTOM_FIELD_VALIDATION_RULES_NOT_ALLOWED"),
    
    CUSTOM_FIELD_VALIDATION_RULES_DUPLICATE_VALUES("CUSTOM_FIELD_VALIDATION_RULES_DUPLICATE_VALUES"),
    
    CUSTOM_FIELD_STATE_REQUIRED("CUSTOM_FIELD_STATE_REQUIRED"),
    
    CUSTOM_FIELD_DISPLAY_SETTINGS_REQUIRED("CUSTOM_FIELD_DISPLAY_SETTINGS_REQUIRED"),
    
    CUSTOM_FIELD_DESCRIPTION_LENGTH_EXCEEDED("CUSTOM_FIELD_DESCRIPTION_LENGTH_EXCEEDED"),
    
    CUSTOM_FIELD_SIZE_REQUIRED("CUSTOM_FIELD_SIZE_REQUIRED"),
    
    CUSTOM_FIELD_SET_BUILT_IN_USAGE("CUSTOM_FIELD_SET_BUILT_IN_USAGE"),
    
    CUSTOM_FIELD_DUPLICATE_USAGE_ID("CUSTOM_FIELD_DUPLICATE_USAGE_ID"),
    
    CUSTOM_FIELD_DUPLICATE_ROLE_ID("CUSTOM_FIELD_DUPLICATE_ROLE_ID"),
    
    CUSTOM_FIELD_ACCESS_RIGHTS_REQUIRED("CUSTOM_FIELD_ACCESS_RIGHTS_REQUIRED"),
    
    CUSTOM_FIELD_ACCESS_RIGHTS_ROLES_REQUIRED("CUSTOM_FIELD_ACCESS_RIGHTS_ROLES_REQUIRED"),
    
    CUSTOM_FIELD_ACCESS_RIGHTS_ALL_USERS_REQUIRED("CUSTOM_FIELD_ACCESS_RIGHTS_ALL_USERS_REQUIRED"),
    
    CUSTOM_FIELD_ACCESS_RIGHTS_ALL_USERS_FALSE_WHEN_ROLES_SPECIFIED("CUSTOM_FIELD_ACCESS_RIGHTS_ALL_USERS_FALSE_WHEN_ROLES_SPECIFIED"),
    
    CUSTOM_FIELD_SELECTION_OPTIONS_NULL("CUSTOM_FIELD_SELECTION_OPTIONS_NULL"),
    
    CUSTOM_FIELD_AVAILABLE_OPTIONS_NULL("CUSTOM_FIELD_AVAILABLE_OPTIONS_NULL"),
    
    CUSTOM_FIELD_NULL_USAGE("CUSTOM_FIELD_NULL_USAGE"),
    
    CUSTOM_FIELD_SET_NULL_FIELD("CUSTOM_FIELD_SET_NULL_FIELD"),
    
    CUSTOM_FIELDS_CONFIGURATION_EMPTY("CUSTOM_FIELDS_CONFIGURATION_EMPTY"),
    
    CUSTOM_FIELD_SET_NULL_ENTRY("CUSTOM_FIELD_SET_NULL_ENTRY"),
    
    CONFIGURATION_AS_CODE_UPDATE_IN_PROGRESS("CONFIGURATION_AS_CODE_UPDATE_IN_PROGRESS"),
    
    CONFIGURATION_AS_CODE_FEATURE_DISABLED("CONFIGURATION_AS_CODE_FEATURE_DISABLED"),
    
    PREPAYMENT_RECALCULATION_METHOD_ON_REPAYMENT_NOT_ALLOWED_FOR_LOAN_ACCOUNT("PREPAYMENT_RECALCULATION_METHOD_ON_REPAYMENT_NOT_ALLOWED_FOR_LOAN_ACCOUNT"),
    
    PREPAYMENT_RECALCULATION_METHOD_ON_REPAYMENT_NOT_SUPPORTED("PREPAYMENT_RECALCULATION_METHOD_ON_REPAYMENT_NOT_SUPPORTED"),
    
    CONFLICT_BETWEEN_EDIT_SCHEDULE_OPERATIONS_AND_ATTEMPTED_PREPAYMENT_RECALCULATION_METHOD("CONFLICT_BETWEEN_EDIT_SCHEDULE_OPERATIONS_AND_ATTEMPTED_PREPAYMENT_RECALCULATION_METHOD"),
    
    CONFLICT_BETWEEN_PREPAYMENT_RECALCULATION_METHOD_FROM_TRANSACTIONS_AND_NEW_SCHEDULE_EDIT("CONFLICT_BETWEEN_PREPAYMENT_RECALCULATION_METHOD_FROM_TRANSACTIONS_AND_NEW_SCHEDULE_EDIT"),
    
    EDITING_INSTALLMENTS_DUE_BEFORE_LAST_PAID_INSTALLMENT_IS_NOT_ALLOWED("EDITING_INSTALLMENTS_DUE_BEFORE_LAST_PAID_INSTALLMENT_IS_NOT_ALLOWED"),
    
    INVALID_INSTALLMENT_KEY("INVALID_INSTALLMENT_KEY"),
    
    INVALID_REPAYMENT_AMOUNT_FOR_SPECIFIC_INSTALLMENT("INVALID_REPAYMENT_AMOUNT_FOR_SPECIFIC_INSTALLMENT"),
    
    SPECIFIC_INSTALLMENT_REPAYMENTS_NOT_ALLOWED_IF_GENERIC_REPAYMENTS_EXIST("SPECIFIC_INSTALLMENT_REPAYMENTS_NOT_ALLOWED_IF_GENERIC_REPAYMENTS_EXIST"),
    
    GENERIC_REPAYMENTS_NOT_ALLOWED_IF_SPECIFIC_INSTALLMENT_REPAYMENTS_EXIST("GENERIC_REPAYMENTS_NOT_ALLOWED_IF_SPECIFIC_INSTALLMENT_REPAYMENTS_EXIST"),
    
    INSTALLMENT_ALREADY_PAID("INSTALLMENT_ALREADY_PAID"),
    
    PREPAYMENT_RECALCULATION_METHOD_NOT_SUPPORTED("PREPAYMENT_RECALCULATION_METHOD_NOT_SUPPORTED"),
    
    ONLY_IOI_METHOD_SUPPORTED("ONLY_IOI_METHOD_SUPPORTED"),
    
    ACCRUE_LATE_INTEREST_NOT_SUPPORTED("ACCRUE_LATE_INTEREST_NOT_SUPPORTED"),
    
    ONLY_PARTIALLY_PAID_STATUS_SUPPORTED("ONLY_PARTIALLY_PAID_STATUS_SUPPORTED"),
    
    ONLY_NO_PENALTY_PRODUCTS_SUPPORTED("ONLY_NO_PENALTY_PRODUCTS_SUPPORTED"),
    
    ACCOUNT_IS_LOCKED("ACCOUNT_IS_LOCKED"),
    
    ONLY_STANDARD_PAYMENTS_SUPPORTED("ONLY_STANDARD_PAYMENTS_SUPPORTED"),
    
    ARBITRARY_FEES_NOT_SUPPORTED("ARBITRARY_FEES_NOT_SUPPORTED"),
    
    TAXES_ON_INTEREST_NOT_SUPPORTED("TAXES_ON_INTEREST_NOT_SUPPORTED"),
    
    REPAYMENT_DUE_DATE_DUPLICATED("REPAYMENT_DUE_DATE_DUPLICATED"),
    
    TAXES_ON_FEE_NOT_SUPPORTED("TAXES_ON_FEE_NOT_SUPPORTED"),
    
    CHANGING_NO_OF_POSITIVE_PRINCIPAL_INSTALLMENTS_NOT_ALLOWED("CHANGING_NO_OF_POSITIVE_PRINCIPAL_INSTALLMENTS_NOT_ALLOWED"),
    
    NOT_ALLOWED_FOR_CURRENT_ACCOUNT_TYPE("NOT_ALLOWED_FOR_CURRENT_ACCOUNT_TYPE"),
    
    NOT_ALLOWED_BEFORE_ACTIVATION_DATE("NOT_ALLOWED_BEFORE_ACTIVATION_DATE"),
    
    NOT_ALLOWED_BEFORE_OR_DURING_PAID_INSTALLMENT("NOT_ALLOWED_BEFORE_OR_DURING_PAID_INSTALLMENT"),
    
    GET_NOTIFICATION_MESSAGE_UPDATE_FAILURE("GET_NOTIFICATION_MESSAGE_UPDATE_FAILURE"),
    
    INVALID_CUSTOM_FILTER_CONSTRAINT_OPERATOR("INVALID_CUSTOM_FILTER_CONSTRAINT_OPERATOR"),
    
    EMPTY_CUSTOM_FILTER_CONSTRAINT_VALUE("EMPTY_CUSTOM_FILTER_CONSTRAINT_VALUE"),
    
    INVALID_CUSTOM_FILTER_CONSTRAINT_VALUE("INVALID_CUSTOM_FILTER_CONSTRAINT_VALUE"),
    
    INVALID_CUSTOM_FILTER_CONSTRAINT_OPERATOR_USAGE("INVALID_CUSTOM_FILTER_CONSTRAINT_OPERATOR_USAGE"),
    
    EMPTY_TRANSACTION_CHANNEL_NAME("EMPTY_TRANSACTION_CHANNEL_NAME"),
    
    EMPTY_TRANSACTION_CHANNEL_ID("EMPTY_TRANSACTION_CHANNEL_ID"),
    
    INVALID_CUSTOM_FILTER_CONSTRAINT_TYPE("INVALID_CUSTOM_FILTER_CONSTRAINT_TYPE"),
    
    INVALID_CUSTOM_FILTER_USAGE("INVALID_CUSTOM_FILTER_USAGE"),
    
    INVALID_CUSTOM_FILTER_CRITERIA("INVALID_CUSTOM_FILTER_CRITERIA"),
    
    INTEREST_ACCRUAL_BREAKDOWN_INTERNAL_ERROR("INTEREST_ACCRUAL_BREAKDOWN_INTERNAL_ERROR"),
    
    INTEREST_ACCRUAL_BREAKDOWN_BAD_REQUEST("INTEREST_ACCRUAL_BREAKDOWN_BAD_REQUEST"),
    
    DUPLICATE_BLOCK_ID("DUPLICATE_BLOCK_ID"),
    
    INVALID_BLOCK_FUND_STATE("INVALID_BLOCK_FUND_STATE"),
    
    BLOCK_FUND_DOES_NOT_EXIST("BLOCK_FUND_DOES_NOT_EXIST"),
    
    S3_REGION_NOT_FOUND("S3_REGION_NOT_FOUND"),
    
    INVALID_TRANSACTION_CHANNEL_ID("INVALID_TRANSACTION_CHANNEL_ID"),
    
    INVALID_ACCOUNTING_METHOD("INVALID_ACCOUNTING_METHOD"),
    
    MISSING_RULE("MISSING_RULE"),
    
    NOT_REQUIRED_RULE("NOT_REQUIRED_RULE"),
    
    HEADER_ACCOUNT_NOT_ALLOWED("HEADER_ACCOUNT_NOT_ALLOWED"),
    
    INVALID_GLACCOUNT_TYPE("INVALID_GLACCOUNT_TYPE"),
    
    RULE_WITHOUT_GLACCOUNT("RULE_WITHOUT_GLACCOUNT"),
    
    INVALID_INTEREST_ACCRUED_METHOD("INVALID_INTEREST_ACCRUED_METHOD"),
    
    GLACCOUNTS_ARE_NOT_IN_ORGANIZATION_OR_PRODUCT_CURRENCY("GLACCOUNTS_ARE_NOT_IN_ORGANIZATION_OR_PRODUCT_CURRENCY"),
    
    INCONSISTENT_GLACCOUNTS_CURRENCY_SETUP("INCONSISTENT_GLACCOUNTS_CURRENCY_SETUP"),
    
    INCONSISTENT_FEE_GLACCOUNTS_CURRENCY_SETUP("INCONSISTENT_FEE_GLACCOUNTS_CURRENCY_SETUP"),
    
    INVALID_GL_ACCOUNT_CURRENCY("INVALID_GL_ACCOUNT_CURRENCY"),
    
    CANNOT_EDIT_GL_ACCOUNT_CURRENCY_AS_ACCOUNT_IS_IN_USE("CANNOT_EDIT_GL_ACCOUNT_CURRENCY_AS_ACCOUNT_IS_IN_USE"),
    
    FOREIGN_CURRENCY_IS_NOT_ALLOWED("FOREIGN_CURRENCY_IS_NOT_ALLOWED"),
    
    INEXISTING_GLACCOUNT("INEXISTING_GLACCOUNT"),
    
    CHANGE_ARREARS_SETTINGS_NOT_ALLOWED_FOR_PRODUCT_TOLERANCE_CALCULATION_METHOD("CHANGE_ARREARS_SETTINGS_NOT_ALLOWED_FOR_PRODUCT_TOLERANCE_CALCULATION_METHOD"),
    
    INVALID_BULK_PROCESS_KEY("INVALID_BULK_PROCESS_KEY"),
    
    BULK_API_REQUEST_SIZE_LIMIT_REACHED("BULK_API_REQUEST_SIZE_LIMIT_REACHED"),
    
    POSITIVE_AMOUNT_REQUIRED("POSITIVE_AMOUNT_REQUIRED"),
