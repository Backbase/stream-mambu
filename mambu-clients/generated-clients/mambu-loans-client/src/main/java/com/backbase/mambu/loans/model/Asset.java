 ...
 */
@ApiModel(description = "Asset, holds information about a client asset entry.")
@JsonPropertyOrder({
  Asset.JSON_PROPERTY_AMOUNT,
  Asset.JSON_PROPERTY_DEPOSIT_ACCOUNT_KEY,
  Asset.JSON_PROPERTY_ASSET_NAME,
  Asset.JSON_PROPERTY_ENCODED_KEY,
  Asset.JSON_PROPERTY_GUARANTOR_KEY,
  Asset.JSON_PROPERTY_GUARANTOR_TYPE
})
...
public class Asset {
  ...
  **/
  ...
  public Asset depositAccountKey(String depositAccountKey) {
  ...
  **/
   ...
   * @return assetName
  **/
  @ApiModelProperty(required = true, value = "The name of a value the client guarantees with (populated when the guaranty type is ASSET)")
  ...
  **/
  ...
  public Asset guarantorKey(String guarantorKey) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The key of the client/group used as the guarantor.")
  ...
  public Asset guarantorType(GuarantorTypeEnum guarantorType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of the guarantor (client/group)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Asset asset = (Asset) o;
    return Objects.equals(this.amount, asset.amount) &&
        Objects.equals(this.depositAccountKey, asset.depositAccountKey) &&
        Objects.equals(this.assetName, asset.assetName) &&
        Objects.equals(this.encodedKey, asset.encodedKey) &&
        Objects.equals(this.guarantorKey, asset.guarantorKey) &&
        Objects.equals(this.guarantorType, asset.guarantorType);
  }
